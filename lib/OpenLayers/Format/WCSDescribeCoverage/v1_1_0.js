...
OpenLayers.Format.WCSDescribeCoverage.v1_1_0 = OpenLayers.Class(
    ...
    readers: {
        "wcs": {
            ...
            "Range": function(node, description) {
                description.range = {
                    "fields": []
                };
                this.readChildNodes(node, description.range);
            },
            "Field": function(node, range) {
                var field = {
                    definition: {},
            ...
            "Definition": function(node, field) {
                this.readChildNodes(node, field.definition);
            },
            "InterpolationMethods": function(node, field) {
                this.readChildNodes(node, field.interpolationMethods);
            },
            "InterpolationMethod": function(node, interpolationMethods) {
                interpolationMethods.push(this.getChildValue(node));
            },
            "Default": function(node, obj) {
                obj.push(this.getChildValue(node));
            },
            "Axis": function(node, field) {
                if (!!!field.axes) {
                    field.axes = [];
                }
                var axis = {
                ...
                this.readChildNodes(node, axis);
                field.axes.push(axis);
            },
            "AvailableKeys": function(node, axis) {
                this.readChildNodes(node, axis.availableKeys); 
            },
            "Key": function(node, availableKeys) {
                availableKeys.push(this.getChildValue(node));
            }
        },
