...
OpenLayers.Format.SLD.v1 = OpenLayers.Class(OpenLayers.Format.Filter.v1_0_0, {
    ...
    readers: OpenLayers.Util.applyDefaults({
        "sld": {
            ...
            "ChannelSelection": function(node, symbolizer) {
                symbolizer.channelSelection = {};
                this.readChildNodes(node, symbolizer.channelSelection);
            },
            "GrayChannel": function(node, channelSelection) {
                channelSelection.grayChannel = {};
                this.readChildNodes(node, channelSelection.grayChannel);
            },
            "RedChannel": function(node, channelSelection) {
                channelSelection.redChannel = {};
                this.readChildNodes(node, channelSelection.redChannel);
            },
            "GreenChannel": function(node, channelSelection) {
                channelSelection.greenChannel = {};
                this.readChildNodes(node, channelSelection.greenChannel);
            },
            "BlueChannel": function(node, channelSelection) {
                channelSelection.blueChannel = {};
                this.readChildNodes(node, channelSelection.blueChannel);
            },
            "SourceChannelName": function(node, channel) {
                channel.sourceChannelName = this.getChildValue(node);
            },
            ...
            "ColorMap": function(node, symbolizer) {
                ...
                symbolizer.colorMap = c;
                this.readChildNodes(node, c.entries);
            },
    ...
    writers: OpenLayers.Util.applyDefaults({
        "sld": {
            ...
            "RasterSymbolizer": function(symbolizer) {
                ...
                if (symbolizer.channelSelection) {
                    this.writeNode("ChannelSelection", symbolizer.channelSelection, node);
                }
                /*
                <ChannelSelection>
                        <GrayChannel>
            ...
            "ChannelSelection": function(channelSelection) {
                var node = this.createElementNSPlus("sld:ChannelSelection");
                if (channelSelection.grayChannel) {
                    this.writeNode("GrayChannel", channelSelection.grayChannel, node);
                }
                if (channelSelection.redChannel) {
                    this.writeNode("RedChannel", channelSelection.redChannel, node);
                }
                if (channelSelection.greenChannel) {
                    this.writeNode("GreenChannel", channelSelection.greenChannel, node);
                }
                if (channelSelection.blueChannel) {
                    this.writeNode("BlueChannel", channelSelection.blueChannel, node);
                }
                return node;
            },
            "GrayChannel": function(grayChannel) {
                var node = this.createElementNSPlus("sld:GrayChannel");
                if (grayChannel.sourceChannelName) {
                    this.writeNode("SourceChannelName", grayChannel.sourceChannelName, node);
                }
                return node;
            },
            "SourceChannelName": function(sourceChannelName) {
                return this.createElementNSPlus("sld:SourceChannelName", {
            ...
            "ColorMap": function(colorMap) {
                ...
                colorMap.type !== undefined && node.setAttribute("type", 
                    colorMap.type);
